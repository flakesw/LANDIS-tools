...
out.dir<-"C:/Users/User/Documents/Postdoc/Beta Diversity/out/Beta Functional Group Output/MIROC/cavity excavators/"
...
for (i in 1:length(scenarios)){
  ...
  soil<-pmatch(fnlg$Soil_aerators,grids)
  soil<-soil[!is.na(soil)]
  sgrids<-grids[soil]
  sgrids<-gsub("\\..*","",sgrids)
...
writeRaster(beta, paste0(out.dir,gsub(in.dir,"",scenarios[i]),"_soilaerators_540_turnover"), format="GTiff")
...
writeRaster(beta, paste0(out.dir,gsub(in.dir,"",scenarios[i]),"_soilaerators_540_nestedness"), format="GTiff")
...
writeRaster(beta, paste0(out.dir,gsub(in.dir,"",scenarios[i]),"_soilaerators_540_meanbeta"), format="GTiff")
