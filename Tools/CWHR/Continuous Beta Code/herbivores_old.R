...
crs(poly2) <- crs(my_stack)

##Run betagrid function with 540 m radius moving window
results_test <- betagrid(gridshp=poly2, comp=newdata, xfeature=2, yfeature=3, radius=540,index="sorensen")
